    ...
    <div className="aboutPage container mt-4">
      <div className="row">
        ...
        <div className="col-sm-4 d-flex flex-column">
          <img src="https://danny-rodriguez.github.io/portfolio/img/professional-shot.jpg" referrerPolicy="no-referrer" alt="Danny Rodriguez LinkedIn Photo" width="416" height="562" />
          <p>
